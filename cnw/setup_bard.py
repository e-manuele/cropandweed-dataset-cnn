...
def setup(data_root, with_mapping):
    ...
    # Apply Torch transformations to images
    ...
    for image_path in os.listdir(os.path.join(data_root, 'images')):
        image = Image.open(os.path.join(data_root, 'images', image_path))
        transformed_image = transforms(image)

        # Save transformed image
        transformed_image = transformed_image.toimage()
        transformed_image.save(os.path.join(data_root, 'images', image_path))
